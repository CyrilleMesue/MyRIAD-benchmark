...
if __name__ == "__main__":
    data_folder = '../more_and_mogonet_data/BRCA/miRNA_data'
    ...
    summarize_imp_feat(featimp_list_list, feature_rankings_path="../more_and_mogonet_data/BRCA/miRNA_data/more_feature_rankings.csv")

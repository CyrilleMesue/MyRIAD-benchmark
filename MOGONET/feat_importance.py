...
def cal_feat_imp(data_folder, model_folder, view_list, num_class):
    ...
    adj_parameter = 2
    dim_he_list = [200,200,200][:num_view]
...
def summarize_imp_feat(featimp_list_list, topn=50, feature_rankings_path="mogenet-feature-ranks.csv"):
    ...
    df_featimp_top.to_csv(feature_rankings_path, index = False)
